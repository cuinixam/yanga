...
class BuildArtifact(Enum):
    REPORT_CONFIG = REPORT_CONFIG_FILE_NAME
...
class CMakeArtifactsLocator:
    ...
    def __init__(self, output_dir: Path, spl_paths: SPLPaths) -> None:
        ...
        self.cmake_variant_reports_dir = self.cmake_build_dir.joinpath(SPLPaths.REPORTS_DIR_NAME)
    ...
    def get_component_reports_dir(self, component_name: str) -> CMakePath:
        return self.get_component_build_dir(component_name).joinpath(SPLPaths.REPORTS_DIR_NAME)
